                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="table-responsive pt-3">
                              ...
                              <table class="tarea" align="center" style="margin:5px 5px 5px 5px">
                                <h2>1:1문의 답변등록</h2>
                                <textarea name="" id="" cols="133.5" rows="10" resize="none" placeholder="1:1문의 답변 내용 입력"></textarea>
                              </table>
                              <div class="">
                                <table class="tt1" border="1" align="center">
                            ...
                            <c:if test="${sessionMemberLv == 1}">
                                    <div class="d-grid gap-3" style="text-align: center">
                                        <a href="<%= request.getContextPath() %>/adList.mt?cpage=1" id="btn" class="btn btn-dark" style="width:150px">취소</a>
