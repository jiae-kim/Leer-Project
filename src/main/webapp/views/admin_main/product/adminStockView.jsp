                ...
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="pro-output">
                                상품 출고 등록
                            </button>
                                <!-- Modal -->
                                <div class="modal fade" id="pro-output" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bolder; color: black;">상품 출고 등록</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body" style="text-align: center; font-size: larger; font-weight: bold;" >
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>출고</td>
                                                        <td><input type="text" name="output" value="출고" readonly></td>
                                                    </tr>
                                                    <tr>
                                                        <td>수량</td>
                                                        <td><input type="text" name="" required placeholder="수량을 입력하세요"></td>
