                    ...
                    <div class="myPageList">
                        <div id="myPage" style="display: block;">
                                        ...
                                        <ul>
                                            <li title="" id="profile">
                                                <div class="profileNic" align="">
                                                    <img src="https://ssl.pstatic.net/static/cafe/cafe_pc/default/cafe_profile_70.png" width="58" height="58" alt="프로필사진" class="imgChange">
                                                    <strong>밤톨이님</strong>
                            ...
                            <div class="writeBoard" align="center">
                                <button onclick="location.href='<%=contextPath%>/comuEnrollForm.bo'"class="write">글쓰기</button>
                            </div>
                        </div> 
