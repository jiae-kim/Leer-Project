	...
	<section class="product spad">
		<div class="container">
			<div class="row">
				...
				<div style="width: 70%">
					<label style="font-size: 25px; font-weight: 600; height: 20px;">FAQ</label>
					<br> <br>
					<table class="table" style="width: 100%" id="list-area">
						...
						<tbody>
							...
							%>
							<tr>
								<td width=300 style="text-align: center"><%=f.getFaqNo()%></td>
								<td width=2000><%=f.getFaqTitle()%></td>
								<td width=300><%=f.getEnrollDate()%></td>
							</tr>
							<%
							}
							%>
					...
					<script>
			        	$(function(){
			        		$("#list-area>tbody>tr").click(function(){
			        			location.href = "<%=contextPath%>/detail.fq?no=" + $(this).children().eq(0).text();
							})
						})
					</script>
				</div>
